...
/**
 * controller with method validations that are disabled in validation.xml
 */
@RestController
@Validated
@RequestMapping("/controller-overrided")
public class ControllerOverridedWithValidationXml {
